...
class TxnMallTest(VoyacoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 VOYA:
        ...
        # First: use raw transaction API to send 1210 VOYA to node1_address,
        # but don't broadcast:
        ...
        # Node0's balance should be starting balance, plus 50VOYA for another
        ...
        # Node0's total balance should be starting balance, plus 100VOYA for 
