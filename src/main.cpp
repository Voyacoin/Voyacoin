...
#if defined(NDEBUG)
# error "Voyacoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Voyacoin Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("voyacoin-scriptch");
