...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CVoyacoinAddress demoAddress = CVoyacoinAddress(CTxDestination(demoPubkey.GetID()));
    Value retValue;
    ...
    CVoyacoinAddress setaccountDemoAddress = CVoyacoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    ...
    BOOST_CHECK(CVoyacoinAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CVoyacoinAddress(arr[0].get_str()).Get() == demoAddress.Get());
}
