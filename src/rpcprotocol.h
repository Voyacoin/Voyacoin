...
#ifndef VOYACOIN_RPCPROTOCOL_H
#define VOYACOIN_RPCPROTOCOL_H
...
enum RPCErrorCode
{
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //! Voyacoin is not connected
