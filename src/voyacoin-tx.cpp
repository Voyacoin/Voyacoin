...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Voyacoin Core voyacoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  voyacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded voyacoin transaction") + "\n" +
              "  voyacoin-tx [options] -create [commands]   " + _("Create hex-encoded voyacoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded voyacoin transaction
