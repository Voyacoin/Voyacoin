...
#ifndef VOYACOIN_QT_VOYACOINUNITS_H
#define VOYACOIN_QT_VOYACOINUNITS_H
...
/** Voyacoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class VoyacoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit VoyacoinUnits(QObject *parent);

    /** Voyacoin units.
      @note Source: https://en.voyacoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        VOYA,
...
typedef VoyacoinUnits::Unit VoyacoinUnit;

#endif // VOYACOIN_QT_VOYACOINUNITS_H
