...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/voyacoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Voyacoin Core"),
     ...
     * override -datadir in the voyacoin.conf file in the default data directory
     * (to be consistent with voyacoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
