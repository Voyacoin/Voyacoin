Voyacoin Core version 0.9.2.1 is now available from:

  https://voyacoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 VOYA to 0.01 VOYA
...
- Fix "Start voyacoin on system login"
