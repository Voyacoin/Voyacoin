Voyacoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/voyacoin/files/Voyacoin/voyacoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Voyacoin
...
New/changed settings (command-line or voyacoin.conf file)
--------------------------------------------------------
