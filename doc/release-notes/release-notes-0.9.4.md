Voyacoin Core version 0.9.4 is now available from:

  https://voyacoin.org/bin/0.9.4/
...
this update is incompatible with the Voyacoin system and could lead to consensus
forks.

Voyacoin Core released binaries from https://voyacoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~voyacoin/+archive/ubuntu/voyacoin
- A third-party or self-compiled Voyacoin Core

upgrade to Voyacoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
