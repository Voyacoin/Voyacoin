Voyacoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/voyacoin/files/Voyacoin/voyacoin-0.5.4/
...
http://gitorious.org/voyacoin/voyacoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Voyacoin-Qt notifications under Growl 1.3.
Increase required age of Voyacoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxVoyacoin properly when installing Voyacoin-Qt over it. (Windows)
