The following is a list of assets used in the voyacoin source and their proper attribution.
...
* License: MIT
* Site: [https://voyacointalk.org/index.php?topic=15276.0](https://voyacointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original voyacoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/voyacoin.icns, src/qt/res/src/voyacoin.svg,
	src/qt/res/src/voyacoin.ico, src/qt/res/src/voyacoin.png,
	src/qt/res/src/voyacoin_testnet.png, docs/voyacoin_logo_doxygen.png,
